...
HOST = '127.0.0.1'
PORT = 5006
FOLDER_ALPHA = "test-images"
FOLDER_BETA = "images-true"
...
if __name__ == "__main__":
    ...
    for folder in [FOLDER_ALPHA, FOLDER_BETA]:
        if not os.path.exists(folder):
            print(f"WARNING: '{folder}' folder not found. This drone will skip.")

    # Start multi-drone simulation
    drone1 = DroneReplay("Alpha", FOLDER_ALPHA, delay=2)
    drone2 = DroneReplay("Beta", FOLDER_BETA, delay=2.5) # Slight offset in delay for variety
